...
def shot_hit(shot_array, alien_matrix, player_score, difficulty_value, barrier_a, barrier_b, barrier_c, barrier_a_hide, barrier_b_hide, barrier_c_hide):
                    ...
                    for alien in alien_matrix[i]:
                        if(shot.collided(alien) and (shot in shot_array)):
                            ...
                            if(alien.total_frames == 1):
                                ...
                                player_score += 10 * difficulty_value
                            elif(alien.total_frames == 2):
                                alien_matrix[i].remove(alien)
                                player_score += 20 * difficulty_value
